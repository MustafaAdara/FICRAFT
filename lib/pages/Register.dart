            ...
            child: Container(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: TextFormField(
                        validator: (firstName){
                          if (firstName!.isEmpty || firstName.length < 6 || firstName.length > 15 ){
                      ...
                      Expanded(child: TextFormField(
                        validator: (lastName){
                          if (lastName!.isEmpty || lastName.length < 6 || lastName.length > 15){
                  ...
                  TextFormField(
                    validator: (location){
                      if (location!.isEmpty || location.length < 3 || location.length > 15){
                  ...
                  TextFormField(
                    obscureText: true,
                    validator: (confirm){
                      if(confirm!.isEmpty || confirm.length < 6 /*|| password != confirmP*/ ){
                  ...
                  TextFormField(
                    obscureText: true,
                    validator: (phone){
                      if(phone!.isEmpty || RegExp(r'^01[0-2,5]{1}[0-9]{8}$').hasMatch(phone!)  ){
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                          onPressed: (){},
                          child: const Text('تسجيل الدخول', style: TextStyle(fontWeight: FontWeight.w900, decoration: TextDecoration.underline ))
                      ),
